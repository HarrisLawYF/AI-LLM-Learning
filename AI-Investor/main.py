...
tools = [
        {
            ...
            "function": {
                ...
                "description": "Create an stock order for user",
                "parameters": {
                    "type": "object",
                    "properties":{
                        "stop-loss": {
...
task = ("# Task \n" +
        ...
        "- help user to purchase the stock with the tool provided with price of stop-loss (in dollar), best price to create a limit-order (in dollar), and stock name. If the user indicates a wish to stop, cancel, or discontinues the process (for example: 'Stop', 'I'll stop', 'Cancel') , "
        ...
        "- If offensive or profane language appears, reply 'Sorry, please stay calm and have a nice day.'")
...
def run_conversation():
    ...
    print('Stock recommendation =', message["content"])
    messages.append(message)
    confirmation = input("Please tell me if you want to proceed the order: ")
