...
# 读取PDF文件
pdf_reader = PdfReader('./TLS+Property+Law+Introduction.pdf')
# 提取文本和页码信息
...
# 使用加载的知识库进行查询
#docs = knowledgeBase.similarity_search("客户经理每年评聘申报时间是怎样的？")
...
# 设置查询问题
query = "What is legal estates and legal interests?"
